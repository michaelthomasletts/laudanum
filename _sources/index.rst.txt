...
A simple Python package and CLI tool for easily creating logos with `ASCII art <https://www.ascii-art.site/FontList.html>`_.
...
Check the CLI documentation :ref:`here <cli>`.

Check the Python documentation :ref:`here <modules>`.
